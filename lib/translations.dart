...
//       'line3_gamal_abd_al_nasser': 'Gamal Abd Al-Nasser',
//       'line3_attaba': 'Attaba',
...
//       'we_wish_you_an_easy_trip': ' نتمني لك رحله سلسه ',
//       'nearest_metro_station': 'أقرب محطة مترو',
//       'please_open_gps': 'يرجى تشغيل خاصية GPS',
...
//       'line1_tura_el_asmant': 'طورا الأسمنت',
//       'line1_kozzika': 'كوزيكا',
//       'line1_tora_el_balad': 'طورا البلد',
//       'line1_sakanat_el_maadi': 'سكانات المعادي',
...
//       'line1_saray_el_kobba': 'سراي القبة',
//       'line1_hadayeq_el_zaitoun': 'حدائق الزيتون',
//       'line1_helmeyat_el_zaitoun': 'حلميات الزيتون',
//       'line1_ain_shams': 'عين شمس',
//       'line1_ezbet_el_nakhl': 'عزبة النخل',
//       'line1_el_marg': 'المرج',
//       'line1_new_el_marg': 'المرج الجديدة',
//
//       // خط المترو 2 - أسماء المحطات
//       'line2_shubra_el_kheima': 'شبرا الخيمة',
//       'line2_kolleyyet_el_zeraa': 'كلية الزراعة',
//       'line2_el_mazallat': 'المزلات',
//       'line2_al_khalafawi': 'الخلافاوي',
//       'line2_st_teresa': 'سانت تيريزا',
//       'line2_rod_el_farag': 'روض الفرج',
//       'line2_masra': 'مسرة',
//       'line2_el_shohada': 'الشهداء',
//       'line2_attaba': 'العباسية',
//       'line2_mohamed_naguib': 'محمد نجيب',
//       'line2_sadat': 'السادات',
//       'line2_opera': 'الأوبرا',
//       'line2_dokki': 'محطة مترو الدقي',
//       'line2_bohouth': 'محطة مترو البحوث',
//       'line2_cairo_university': 'جامعة القاهرة',
//       'line2_faisal': 'محطة فيصل',
//       'line2_giza': 'محطة جيزة',
//       'line2_omm_el_misryeen': 'أم المصريين',
//       'line2_sakiat_mekki': 'ساقية مكي',
//       'line2_el_monib': 'المنيب',
//
//       // خط المترو 3 - أسماء المحطات
//       'line3_tawfikia': 'توفقية',
//       'line3_wadi_al_nile': 'محطة مترو وادي النيل',
//       'line3_arab_league': 'محطة مترو جامعة الدول العربية',
//       'line3_boulaq': 'محطة مترو بولاق',
//       'line3_roud_al_farag_axis': 'محور روض الفرج',
//       'line3_ring_road': 'الطريق الدائري',
//       'line3_national': 'محطة المترو الوطنية',
//       'line3_al_bouhi': 'البوهى',
//       'line3_imbaba': 'إمبابة',
//       'line3_al_sudan': 'السودان',
//       'line3_kit_kat': 'كيت كات',
//       'line3_safaa_hegazy': 'صفاء حجازي',
//       'line3_maspero': 'ماسبيرو',
//       'line3_gamal_abd_al_nasser': 'جمال عبد الناصر',
//       'line3_attaba': 'العباسية',
//       'line3_bab_el_shaariya': 'باب الشعارية',
//       'line3_el_geish': 'الجيش',
//       'line3_abdou_pasha': 'عبدو باشا',
//       'line3_el_abassiya': 'العباسية',
//       'line3_fair_zone': 'منطقة المعارض',
//       'line3_cairo_stadium': 'استاد القاهرة',
//       'line3_kolleyet_el_banat': 'كلية البنات',
//       'line3_el_ahram': 'الأهرام',
//       'line3_haroun': 'هارون',
//       'line3_heliopolis': 'مصر الجديدة',
...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      'nearest_station': 'Nearest Metro Station',
      ...
      'route_from_to': 'From: @start\nTo: @end',
      'minutes': ' minutes',
      'stations': ' stations',
      'from_to': 'From: @start\nTo: @end',
      'same_line': 'Both stations are on the same line (@line)',
      'transfer_station':
          'Transfer station: @station (from @startLine to @endLine)',
      'transfer_stations':
          'Available transfer stations: @stations (from @startLine to @endLine)',
      'no_transfer': 'No known transfer stations between the two lines',
    ...
    'ar': {
      ...
      'we_wish_you_an_easy_trip': 'نتمنى لك رحلة سهلة',
      'nearest_metro_station': 'أقرب محطة مترو',
      'please_open_gps': 'يرجى تشغيل خاصية GPS',
      'start_station': 'محطة البداية',
      'end_station': 'محطة النهاية',
      ...
      'line1_helwan_university': 'جامعة حلوان',
      'line1_wadi_hoff': 'وادي حوف',
      'line1_helwan_garden': 'حديقة حلوان',
      'line1_el_maasara': 'المعصرة',
      'line1_tura_el_asmant': 'طرة الأسمنت',
      'line1_kozzika': 'كزّيكة',
      'line1_tora_el_balad': 'طرة البلد',
      'line1_sakanat_el_maadi': 'سكنات المعادي',
      'line1_el_maadi': 'المعادي',
      'line1_hadayeq_el_maadi': 'حدائق المعادي',
      'line1_dar_el_salam': 'دار السلام',
      'line1_el_zahraa': 'الزهراء',
      ...
      'line1_ain_shams': 'عين شمس',
      'line1_ezbet_el_nakhl': 'عزبة النخل',
      'line1_el_marg': 'المطرية',
      'line1_new_el_marg': 'المطرية الجديدة',
      ...
      'line2_bohouth': 'محطة مترو البحوث',
      'line2_cairo_university': 'جامعة القاهرة',
      'line2_faisal': 'محطة مترو فيصل',
      'line2_giza': 'محطة مترو الجيزة',
      'line2_omm_el_misryeen': 'أم المصريين',
      'line2_sakiat_mekki': 'سقية مكي',
      'line2_el_monib': 'المنيب',

      // خط المترو 3 - Line 3 stations
      'line3_tawfikia': 'التحفيقية',
      'line3_wadi_al_nile': 'وادي النيل',
      'line3_arab_league': 'محطة مترو جامعة الدول العربية',
      'line3_boulaq': 'محطة مترو بولاق',
      'line3_roud_al_farag_axis': 'محور روض الفرج',
      'line3_ring_road': 'طريق الدائري',
      'line3_national': 'المحطة الوطنية',
      ...
      'line3_qubaa': 'قُباء',
      'line3_omar_ibn_el_khattab': 'عمر بن الخطاب',
      'line3_el_haykestep': 'الهايكس تب',
      'line3_adli_mansour': 'عدلي منصور',

      'select_metro_line': 'اختر خط المترو',
      'nearest_station': 'أقرب محطة مترو',
      ...
      'no_transfer': 'لا يوجد محطات تبديل معروفة بين الخطين',
      'unknown_station': 'إحدى المحطات غير معروفة',
    },
  };
}
